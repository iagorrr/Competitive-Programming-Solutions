/*
- Comecando em i, eu poderia encher o proximo ate o maximo desde que nao passe
pro anterior, o corneer case seria no que vem antes do i kjkjkj
*/
#pragma once
/*8<{==========~ BEGIN TEMPLATE ~============>8*/
#include <bits/stdc++.h>
...
void __run() {
  ...
  repn(i, N) {
    ...
    // handle when they are equal appart
